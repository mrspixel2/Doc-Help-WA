...
import TuberculosisPredictorPage from '../pages/desease-predictors/tuberculosis/predictor-page';
...
export const defaultRoutes: IRoute[] = [
  ...
  {
    path: 'tuberculosis_predictor',
    component: TuberculosisPredictorPage
  },
  {
    path: 'covid_predictor',
